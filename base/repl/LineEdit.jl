...
for f in [:edit_insert, :edit_backspace, :edit_move_left, :edit_move_right,
          :edit_move_word_left, :edit_move_word_right]
...
function edit_transpose(s::MIState)
    edit_transpose(buffer(s)) && refresh_line(s)
    :edit_transpose
end
